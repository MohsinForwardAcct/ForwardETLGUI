...
class LandingPage(Container):
    ...
    async def GetMainInterFace(self, e):
        ...
        elif LabelName == "Variable List": MainScreen = self.GetMainScreen(GVL.GUIVariableList(self.page, self.Download).ReportingScreen); await self.UpdateScreen(MainScreen)
